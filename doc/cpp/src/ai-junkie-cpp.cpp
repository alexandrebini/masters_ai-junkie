...
void Crossover(string &offspring1, string &offspring2) {
	...
	if (RANDOM_NUM < CROSSOVER_RATE) {
		...
		string t1 = offspring1.substr(0, crossover) + offspring2.substr(
				crossover, CHROMO_LENGTH);
		string t2 = offspring2.substr(0, crossover) + offspring1.substr(
				crossover, CHROMO_LENGTH);
